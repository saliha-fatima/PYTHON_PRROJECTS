...
def view_sales_statistics():
    ...
    for sale in sales:
        sales_list.insert("", "end", values=(sale['serial'], sale['name'], sale['code'], sale['quantity'], sale['unit_price'], sale['item_price']))
...
def export_sales_to_csv():
    ...
    try:
        with open('sales.csv', mode='w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(["Serial", "Name", "Code", "Quantity", "Unit Price", "Item Price"])
            for sale in sales:
                writer.writerow([sale['serial'], sale['name'], sale['code'], sale['quantity'], sale['unit_price'], sale['item_price']])
...
sales_list = ttk.Treeview(statistics_frame, columns=("Serial", "Name", "Code", "Quantity", "Unit Price", "Item Price"), show="headings", style="Treeview")
for col in ["Serial", "Name", "Code", "Quantity", "Unit Price", "Item Price"]:
